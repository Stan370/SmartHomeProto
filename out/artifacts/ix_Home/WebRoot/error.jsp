...
<html lang="en">
    ...
    <body id="page-top" >
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav" style="background: #000;color: #fff;">
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-8 text-center">
                        <h2 class="mt-0">Invalid user ID or Password! Check it again.</h2>
                        <hr class="divider" />
                        <a class="btn btn-dark btn-xl" href="login.jsp">Return</a>
                        <hr class="divider" />
                    </div>
                </div>                    
